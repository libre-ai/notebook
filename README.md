...
- Situation actuelle : L'application Notebook, née dans le hub et greffée ici avec son histoire (γ 3.5), installe et teste verte sur les briques épinglées de la constellation ; le crate notebook-core (frontière WIT, patch aes audité) vit dans ce workspace, son intégration WASM dans les parcours de l'application reste à faire.
- Maturité : usable
